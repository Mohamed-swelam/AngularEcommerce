import { AfterViewChecked, Component, ElementRef, EventEmitter, Input, input, OnChanges, Output, SimpleChanges, ViewChild } from '@angular/core';
...
@Component({
  ...
  imports: [LimitPipe, Zooming, FormsModule, Buttons],
  templateUrl: './products.html',
  styleUrl: './products.css',
})
export class Products implements OnChanges, AfterViewChecked {
  ProdList: IProduct[];
  ...
  filterByCategory() {
    if (this.selectedCategory === 'all') {
      ...
      this.filteredProducts = this.ProdList.filter(product => product.category === this.selectedCategory);
